...
/**
    ...
    public void activeUser(User user2, String activeCode) throws SQLException {
        UserDao dao = new UserDao();
...
/**
    ...
    public User login(User user2, String username, String password) throws LoginException {
        UserDao dao = new UserDao();
        try {
