 ...
 */
@WebServlet(name = "SessionCodeServlet",urlPatterns = "/session/code")
public class SessionCodeServlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        drewVerificationCode(request, response);
    }

    public void drewVerificationCode(HttpServletRequest request, HttpServletResponse response) throws IOException {
        /**
