...
public class CartServlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) {
        try {
            ...
            if ("add".equals(method)) {             //新增
                ...
                changeCartNum(request, response);
            } else if("remove".equals(method)){     //删除商品
                removeProductOnCart(request, response);
            } else if("removeSelect".equals(method)){//删除选中商品
                removeSelectProductOnCart(request, response);
            }
        } catch (IOException e) {
            e.printStackTrace();
        }
     ...
     * @throws IOException
     */
    public void removeSelectProductOnCart(HttpServletRequest request, HttpServletResponse response) throws IOException {
        //选中商品的id
     ...
     * @throws IOException
     */
    public void removeProductOnCart(HttpServletRequest request, HttpServletResponse response) throws IOException {
        // 得到要删除的商品的id
     ...
     * @throws IOException
     */
    public void changeCartNum(HttpServletRequest request, HttpServletResponse response) throws IOException {
        // 1.得到请求参数
        String id = request.getParameter("id");
